...
int main()
{
  ...
  ASSERT(1, ({ int x[2][3]; int *y=x; y+= 1; *y=1; *(*x+1); }));
  ASSERT(2, ({ int x[2][3]; int *y=x; y+= 2; *y=2; *(*x+2); }));
  ASSERT(3, ({ int x[2][3]; int *y=x; y+= 3; *y=3; **(x+1); }));
  ASSERT(4, ({ int x[2][3]; int *y=x; y+= 4; *y=4; *(*(x+1)+1); }));
  ASSERT(5, ({ int x[2][3]; int *y=x; y+= 5; *y=5; *(*(x+1)+2); }));
